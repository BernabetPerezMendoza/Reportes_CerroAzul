...
<head>
    ...
    <title>Mi Perfil - Lunahuaná Limpia</title>
...
<body class="bg-[#F8FAFC] min-h-screen font-sans text-slate-800 selection:bg-blue-200">
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="mb-8">
            <h2 class="text-3xl font-extrabold text-slate-900">Configuración de Cuenta</h2>
            <p class="text-slate-500 mt-2">Gestiona tus credenciales de acceso a la plataforma.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-8">
            ...
            <div class="md:col-span-3">
                <div class="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-200">
                    ...
                    <form action="index.php?action=actualizar_perfil" method="POST" class="space-y-5">
    ...
    <script>
        // Guardamos el username original para no marcar error si no lo cambia
        ...
        async function validarUsername() {
            ...
            // Si el usuario escribe su mismo username actual, no hay problema
            ...
            btnSubmit.disabled = true; // Bloquea el botón mientras consulta a la base de datos
            ...
            timeoutUsername = setTimeout(async () => {
                try {
                    ...
                    if (result.existe) {
                        ...
                        btnSubmit.disabled = true; // Bloquea si ya existe
                    } else {
                        ...
                        btnSubmit.disabled = false; // Habilita si está libre
                    }
                } catch (error) {
